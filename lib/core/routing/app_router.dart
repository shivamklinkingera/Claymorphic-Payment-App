...
import '../../features/support/presentation/pages/faq_detail_page.dart';
...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/fund-details', builder: (context, state) => FundDetailsPage(fundName: state.extra as String? ?? "Fund")),
    ...
    GoRoute(path: '/faq-upi-reset', builder: (context, state) => const FaqDetailUpiPinResetPage()),
    GoRoute(path: '/faq-detail', builder: (context, state) => const FaqDetailPage()),
    ...
    GoRoute(path: '/group-details', builder: (context, state) => GroupDetailsPage(groupName: state.extra as String? ?? "Group")),
    ...
    GoRoute(path: '/bill-success', builder: (context, state) {
      final extra = state.extra as Map<String, dynamic>? ?? {};
      return BillPaymentSuccessPage(billerName: extra['billerName'] ?? "Biller", amount: extra['amount'] ?? 0.0);
    }),
    GoRoute(path: '/send-money', builder: (context, state) => const SelectContactPage()),
    GoRoute(path: '/send-money/amount', builder: (context, state) => SendMoneyAmountPage(contact: state.extra as Contact)),
